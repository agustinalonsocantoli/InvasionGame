...
pygame.display.set_caption("Invasíon Espacial")
...
while se_ejecuta:
    ...
    # Mantener dentro de borde al Enemigo
        ...
        # Impacto
        impacto = hay_colision(enemigo_x[e], enemigo_y[e], bala_x, bala_y)
        if impacto:
            sonido_impacto = mixer.Sound("Sonidos/Golpe.mp3")
            sonido_impacto.play()
            bala_y = 500
            bala_visible = False
            puntaje += 1
    ...
    mostrar_puntajes(texto_x, texto_y)
